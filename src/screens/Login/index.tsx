    ...
    <View
      ...
      <View
        ...
        <Text
          ...
          Hot Updater supabase 3434ttyty
        </Text>
        ...
        {/* <Text style={{marginVertical: 16, textTransform: 'capitalize'}}>
          {vi.login_system}
        </Text> */}
        <TextFieldPrimary
        ...
        <Pressable onPress={() => HotUpdater.reload()}>
          <Text>Reload</Text>
        </Pressable>
        ...
        <HStack style={{justifyContent: 'space-between'}}>
          ...
          <Pressable
            ...
            style={{backgroundColor: colors.orangeDark}}>
            <Text
              style={{
                color: colors.paper,
              ...
              {loading ? 'Loading' : vi.login.toUpperCase()}
            </Text>
          </Pressable>
        </HStack>
      </View>
